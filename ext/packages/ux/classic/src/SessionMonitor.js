 ...
 * logged out.
 */
Ext.define('Ext.ux.SessionMonitor', {
    singleton: true,
    interval: 1000 * 10,  // run every 10 seconds.
    lastActive: new Date(),
    maxInactive: 1000 * 60 * 240,  // 15 minutes of inactivity allowed; set it to 1 for testing.
    remaining: 0,
    ui: Ext.getBody(),
    /**
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
            ...
            handler: function () {
                Ext.TaskManager.stop(Ext.ux.SessionMonitor.countDownTask);
                Ext.ux.SessionMonitor.window.hide();
                Ext.ux.SessionMonitor.start();
